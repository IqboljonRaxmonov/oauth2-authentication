...
//        }
        ...
        if(!StringUtils.isEmpty(oAuth2UserInfo.getEmail())) {
           ...
           userOptional=userRepository.findByEmail(oAuth2UserInfo.getLogin());
        }
        User user;
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setEmail(oAuth2UserInfo.getEmail()!=null?oAuth2UserInfo.getEmail():oAuth2UserInfo.getLogin());
